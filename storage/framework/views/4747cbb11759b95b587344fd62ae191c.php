                ...
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                    ...
                    <?php if($paginator->onFirstPage()): ?>
                        <span aria-disabled="true" aria-label="<?php echo e(__('pagination.previous')); ?>">
                            <span class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-l-md leading-5 dark:bg-dark-800 dark:border-gray-600" aria-hidden="true">
...
<?php endif; ?>
<?php /**PATH F:\Projects\laravel\laracast11\resources\views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>